...
.controller('CoverCtrl', function($scope, $ionicModal, ionicDatePicker, ionicTimePicker, $http, UserService, CoverService) {
  
  $scope.on("update", function() {
    $scope.data = {
      prize : UserService.prize(),
      shift : UserService.shift(),
    }
  })
